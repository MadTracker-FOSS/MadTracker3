...
double MTDelay::getparam(int cat, int id, char *display)
{
    ...
    {
        case 0:
            return taps[cat].flags;
        case 1:
            return taps[cat].delay;
        case 2:
            return taps[cat].volume;
        case 3:
            return taps[cat].feedback;
        case 4:
            return taps[cat].pan[0].pan;
        case 5:
            return taps[cat].pan[0].amp;
        case 6:
            return taps[cat].pan[0].period;
        case 7:
            return taps[cat].pan[0].phase;
        case 8:
            return taps[cat].pan[1].pan;
        case 9:
            return taps[cat].pan[1].amp;
        case 10:
            return taps[cat].pan[1].period;
        case 11:
            return taps[cat].pan[1].phase;
        case 12:
            return taps[cat].pan[2].pan;
        case 13:
            return taps[cat].pan[2].amp;
        case 14:
            return taps[cat].pan[2].period;
        case 15:
            return taps[cat].pan[2].phase;
        default:
            return 0.0;
    };
}
...
void MTDelay::setparam(int cat, int id, double value, int steps)
{
    ...
    {
        case 0:
            taps[cat].flags = (int) value;
            break;
        case 1:
            taps[cat].delay = (float) value;
            break;
        case 2:
            taps[cat].volume = (float) value;
            break;
        case 3:
            taps[cat].feedback = (float) value;
            break;
        case 4:
            taps[cat].pan[0].pan = (float) value;
            break;
        case 5:
            taps[cat].pan[0].amp = (float) value;
            break;
        case 6:
            taps[cat].pan[0].period = (float) value;
            break;
        case 7:
            taps[cat].pan[0].phase = (float) value;
            break;
        case 8:
            taps[cat].pan[1].pan = (float) value;
            break;
        case 9:
            taps[cat].pan[1].amp = (float) value;
            break;
        case 10:
            taps[cat].pan[1].period = (float) value;
            break;
        case 11:
            taps[cat].pan[1].phase = (float) value;
            break;
        case 12:
            taps[cat].pan[2].pan = (float) value;
            break;
        case 13:
            taps[cat].pan[2].amp = (float) value;
            break;
        case 14:
            taps[cat].pan[2].period = (float) value;
            break;
        case 15:
            taps[cat].pan[2].phase = (float) value;
            break;
        default:
            break;
    };
