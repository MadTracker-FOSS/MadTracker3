    ...
    Skin()
{
    ...
    sko[0].a = &bkg;
    sko[0].s = sizeof(bkg);
    sko[0].p = sizeof(MTSkinPart);
    sko[1].k = "Fonts";
    sko[1].t = sk_font;
    sko[1].a = &fnm;
    sko[1].s = sizeof(fnm);
    sko[1].p = sizeof(MTFNMetrics);
    sko[2].k = "Windows";
    sko[2].t = sk_wins;
    sko[2].a = &wnm;
    sko[2].s = sizeof(wnm);
    sko[2].p = sizeof(MTWNMetrics);
    sko[3].k = "Buttons";
    sko[3].t = sk_btns;
    sko[3].a = &btm;
    sko[3].s = sizeof(btm);
    sko[3].p = sizeof(MTBTMetrics);
    sko[4].k = "Tab Buttons";
    sko[4].t = sk_tbtn;
    sko[4].a = &tbtm;
    sko[4].s = sizeof(tbtm);
    sko[4].p = sizeof(MTBTMetrics);
    sko[5].k = "Disabled Tab Buttons";
    sko[5].t = sk_dtbt;
    sko[5].a = &dtbtm;
    sko[5].s = sizeof(dtbtm);
    sko[5].p = sizeof(MTBTMetrics);
    sko[6].k = "Window Buttons";
    sko[6].t = sk_wbtn;
    sko[6].a = &wbtns;
    sko[6].s = sizeof(wbtns);
    sko[6].p = sizeof(MTSQMetrics);
    sko[7].k = "Disabled Window Buttons";
    sko[7].t = sk_dbtn;
    sko[7].a = &dbtns;
    sko[7].s = sizeof(dbtns);
    sko[7].p = sizeof(MTSQMetrics);
    sko[8].k = "Main Window Buttons";
    sko[8].t = sk_mbtn;
    sko[8].a = &mbtns;
    sko[8].s = sizeof(mbtns);
    sko[8].p = sizeof(MTSQMetrics);
    sko[9].k = "Arrows";
    sko[9].t = sk_arrw;
    sko[9].a = &arm;
    sko[9].s = sizeof(arm);
    sko[9].p = sizeof(MTSkinPart);
    sko[10].k = "Combo-box";
    sko[10].t = sk_cbbt;
    sko[10].a = &cbbm;
    sko[10].s = sizeof(cbbm);
    sko[10].p = sizeof(MTSkinPart);
    sko[11].k = "Horizontal Scroller";
    sko[11].t = sk_hscr;
    sko[11].a = &hscm;
    sko[11].s = sizeof(hscm);
    sko[11].p = sizeof(MTBTMetrics);
    sko[12].k = "Vertical Scroller";
    sko[12].t = sk_vscr;
    sko[12].a = &vscm;
    sko[12].s = sizeof(vscm);
    sko[12].p = sizeof(MTBTMetrics);
    sko[13].k = "Horizontal Lift";
    sko[13].t = sk_hscb;
    sko[13].a = &hscbm;
    sko[13].s = sizeof(hscbm);
    sko[13].p = sizeof(MTBTMetrics);
    sko[14].k = "Vertical Lift";
    sko[14].t = sk_vscb;
    sko[14].a = &vscbm;
    sko[14].s = sizeof(vscbm);
    sko[14].p = sizeof(MTBTMetrics);
    sko[15].k = "Disabled Horizontal Scroller";
    sko[15].t = sk_hdsc;
    sko[15].a = &hdscm;
    sko[15].s = sizeof(hdscm);
    sko[15].p = sizeof(MTBTMetrics);
    sko[16].k = "Disabled Vertical Scroller";
    sko[16].t = sk_vdsc;
    sko[16].a = &vdscm;
    sko[16].s = sizeof(vdscm);
    sko[16].p = sizeof(MTBTMetrics);
    sko[17].k = "Status Buttons";
    sko[17].t = sk_stbt;
    sko[17].a = &sbm;
    sko[17].s = sizeof(sbm);
    sko[17].p = sizeof(MTSkinPart);
    sko[18].k = "Pattern";
    sko[18].t = sk_patt;
    sko[18].a = &ptm;
    sko[18].s = sizeof(ptm);
    sko[18].p = sizeof(MTBTMetrics);
    sko[19].k = "Horizontal Slider";
    sko[19].t = sk_hsli;
    sko[19].a = &hslm;
    sko[19].s = sizeof(hslm);
    sko[19].p = sizeof(MTSLMetrics);
    sko[20].k = "Vertical Slider";
    sko[20].t = sk_vsli;
    sko[20].a = &vslm;
    sko[20].s = sizeof(vslm);
    sko[20].p = sizeof(MTSLMetrics);
    sko[21].k = "Knob";
    sko[21].t = sk_knob;
    sko[21].a = &knm;
    sko[21].s = sizeof(knm);
    sko[21].p = sizeof(MTSLMetrics);
    sko[22].k = "Volume Slider";
    sko[22].t = sk_vols;
    sko[22].a = &vsm;
    sko[22].s = sizeof(vsm);
    sko[22].p = sizeof(MTSLMetrics);
    sko[23].k = "Vu-meter";
    sko[23].t = sk_vume;
    sko[23].a = &vum;
    sko[23].s = sizeof(vum);
    sko[23].p = sizeof(MTSLMetrics);
    sko[24].k = "Animation";
    sko[24].t = sk_anim;
    sko[24].a = &animm;
    sko[24].s = sizeof(animm);
    sko[24].p = sizeof(MTSQMetrics);
    sko[25].k = "Icon";
    sko[25].t = sk_icon;
    sko[25].a = &icom;
    sko[25].s = sizeof(icom);
    sko[25].p = sizeof(MTSQMetrics);
    sko[26].k = "Checkbox Buttons";
    sko[26].t = sk_chkb;
    sko[26].a = &cbm;
    sko[26].s = sizeof(cbm);
    sko[26].p = sizeof(MTSkinPart);
    sko[27].k = "Radio Buttons";
    sko[27].t = sk_radb;
    sko[27].a = &rbm;
    sko[27].s = sizeof(rbm);
    sko[27].p = sizeof(MTSkinPart);
    sko[28].k = "Image List";
    sko[28].t = sk_imag;
    sko[28].a = &ilm;
    sko[28].s = sizeof(ilm);
    sko[28].p = sizeof(MTSQMetrics);
    sko[29].k = "Progress Bar";
    sko[29].t = sk_prog;
    sko[29].a = &prm;
    sko[29].s = sizeof(prm);
    sko[29].p = sizeof(MTSLMetrics);
    sko[30].k = "Skin Information";
    sko[30].t = sk_skin;
    sko[30].a = &info;
    sko[30].s = sizeof(info);
    sko[30].p = sizeof(MTSkinInfo);
    sko[31].k = "Bitmap Indexes";
    sko[31].t = sk_bmid;
    sko[31].a = &bmpid;
    sko[31].s = sizeof(bmpid);
    sko[31].p = sizeof(int);
}
...
void MTSkin::loadfromres(MTResources* res)
{
    ...
    {
        LOGD("%s - [GUI] ERROR: Cannot load skin!"
                 NL);
    };
    LEAVE();
}
...
//	List Item
        {
            ...
            else
            {
                ...
                if (li.flags & MTCF_SELECTED)
                {
                    color = fnm.colors[SC_EDIT_SELECTED & 0xFFFF];
                }
                else if (li.flags & MTCF_OVER)
                {
...
//	Window
        {
            ...
            if ((cstyle == 1) || (cstyle == 3) || (cstyle == 4))
            {
                ...
                tflags = DTXT_VCENTER;
                if (fnm.caption.flags & SF_CENTER)
                {
                    tflags |= DTXT_CENTER;
                }
...
//	Button
        {
            ...
            else if ((bc.flags & MTCF_FOCUSED) && (flags))
            {
                bt = 2;
            }
            else if (bc.flags & MTCF_OVER)
            {
                bt = 1;
            }
            else
