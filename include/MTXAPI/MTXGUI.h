...
enum
{
    DB_LEFT = 1, DB_RIGHT = 2, DB_MIDDLE = 4, DB_DOUBLE = 8, DB_SHIFT = 32, DB_CONTROL = 64, DB_ALT = 128
};
...
enum
{
    MTWA_HIDE = 0, MTWA_SHOW, MTWA_MINIMIZE, MTWA_MAXIMIZE, MTWA_CLOSE
};

enum
{
    MTGM_DOUBLECLICK = 0, MTGM_DRAGX, MTGM_DRAGY, MTGM_GRIDX, MTGM_GRIDY
};
